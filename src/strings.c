...
const u8 gText_BattleScene[] = _("ANIM. COMBAT");
const u8 gText_BattleStyle[] = _("STYLE COMBAT");
const u8 gText_Sound[] = _("SON");
const u8 gText_Frame[] = _("CADRE");
...
const u8 gText_TextSpeedMid[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}MOY");
const u8 gText_TextSpeedFast[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}RAPIDE");
...
const u8 gText_BattleStyleShift[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}VARIABLE");
