...
#define FLAG_IS_CHAMPION                            (SYSTEM_FLAGS + 0x1F) // Seems to be related to linking, also used to block access to LittleRoot Starter's Den while the player is not CHAMPION
